...
DEFAULT_FORMATION = Formation(
  ...
  name="example-formation",
  url="https://example-formation.tenant.on.cplane.cloud/",
  flights=[Flight(name="example-flight", oid="flt-0oug6ng05tvll000e14k2sd3og", image="registry.cplane.cloud/seaplane-demo/nginxdemos/hello:latest",  status="healthy")],
...
def test_given_compute_get_formations_page_returns_formations_and_meta(  # type: ignore
    compute_api, get_formations_page,
) -> None:    
...
def test_given_compute_delete_formation_returns_ok(  # type: ignore
    compute_api, delete_formation,
) -> None:    

    assert compute_api.delete("frm-0oug6ng05tvll000e14k2sd3og") == True
